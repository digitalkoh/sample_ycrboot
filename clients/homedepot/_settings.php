<?php
	...
	// Site Title
	define("_SITE_TITLE", "Home Depot States Exchange Program");
	
	// Site Name
	define("_SITE_NAME", "Home Depot States Exchange Program");
	
	// Support Phone Number
	define("_PHONE_NUM", "Questions? 1 800 234 5678");
	
	// Welcome Title (Large)
	$welcomeTextLarge = "Welcome Message (Home Depot)";
	...
	$clientPagesA_title = "Home Depot Resources";
	...
	$clientPagesB_title = "Home Depot Resources 2";
