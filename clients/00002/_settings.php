<?php
	...
	// Site Name
	define("_SITE_NAME", "Best Buy States Exchange Program");
	
	// Support Phone Number
	define("_PHONE_NUM", "Questions? 1 800 000 0000");
	
	// Welcome Title (Large)
	$welcomeTextLarge = "Welcome Message (Best Buy)";
	...
	define("_MOD_Q1", "Income");
	define("_MOD_Q2", "State");
	define("_MOD_Q3", "Spouse");
	define("_MOD_Q4", "Children?");
	define("_MOD_Q5", "Are you covered?");
	...
	$clientPagesA_title = "Best Buy Resources";
	...
	$clientPagesB_title = "Best Buy Resources 2";
