<?php
	...
	define("_PHONE_NUM", "Questions? 1 800 111 5678");
	
	// Welcome Title (Large)
	$welcomeTextLarge = "Welcome to Your Resource for Health Care Coverage";
	
	// Welcome Text Paragraph
	$welcomeText = "You've come to the right place if you don't have access to employer-provided health coverage in 2014. This site will help you learn if you can receive financial assistance to help reduce the cost of health insurance coverage. It also provides information about Medicare, Medicaid, and the Children's Health Insurance Program (CHIP).";
